...
public class BinaryTree implements Dictionary {
  ...
  private BinaryTreeNode findHelper(Comparable key, BinaryTreeNode node) {
	...
	if (node != null){
		if (key.compareTo(node.entry.key())==0){
			...
			return findHelper((Comparable)key,node.leftChild);
		}
		else {
			return findHelper((Comparable)key,node.rightChild);
		}
	}
	else{
		return null;
  ...
  public Entry remove(Object key) {
    // Replace the following line with your solution.
	  BinaryTreeNode rem_node =  findHelper((Comparable)key, root);
	  if(rem_node != null){
		  size--;
		  if(rem_node == root){
			  if(rem_node.rightChild != null){
				  if(rem_node.leftChild ==null){
					  root = rem_node.rightChild;
					  rem_node.rightChild.parent = null;
				  }else{
					  BinaryTreeNode cur = rem_node.rightChild;
					  while(cur.leftChild != null){
						  cur = cur.leftChild;
					  }
					  if(cur != rem_node.rightChild){
						  cur.parent.leftChild = cur.rightChild;
						  if(cur.rightChild != null){
							  cur.rightChild.parent = cur.parent;
						  }
						  cur.rightChild = rem_node.rightChild;
						  rem_node.rightChild.parent = cur;
					  }
					  root = cur;
					  cur.parent = null;
					  cur.leftChild = rem_node.leftChild;
					  rem_node.leftChild.parent = cur;
				  }
			  }else if(rem_node.leftChild != null){
				  root = rem_node.leftChild;
				  rem_node.leftChild.parent = null;
			  }else{
				  root = null;
			  }
		  }else{
			  BinaryTreeNode p = rem_node.parent;
			  if(rem_node == p.leftChild){
				  if(rem_node.rightChild != null){
					  if(rem_node.leftChild == null){
						  p.leftChild = rem_node.rightChild;
						  rem_node.rightChild.parent = null;
					  }else{
						  BinaryTreeNode cur = rem_node.rightChild;
						  while(cur.leftChild != null){
					  ...
					  p.leftChild = rem_node.leftChild;
					  rem_node.leftChild.parent = p;
				  }else{
					  p.leftChild = null;
				  }
			  }else{
				  if(rem_node.rightChild != null){
					  if(rem_node.leftChild == null){
						  p.rightChild = rem_node.rightChild;
						  rem_node.rightChild.parent = p;
					  }else{
						  BinaryTreeNode cur = rem_node.rightChild;
						  while(cur.leftChild != null){
							  cur = cur.leftChild;
					  ...
					  p.rightChild = rem_node.leftChild;
					  rem_node.leftChild.parent = p;
				  }else{
					  p.rightChild = null;
				  }
