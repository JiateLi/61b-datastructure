...
public class SList {
  ...
  public void insertEnd(Object obj) {
	...
	if (head == null) {
      ...
      //SListNode node = head;
    	SListNode mid = new SListNode(obj);//SListNode node = tail;
    	tail.next = mid;
    	tail = mid;
...
//	SListNode p1 = new SListNode(6);
	//SListNode p2 = new SListNode(9);
	//SListNode p3 = new SListNode(12);
	//mylist.insertFront(p3);
//	mylist.insertFront(p2);
	//mylist.insertFront(p1);
	...
	//SListNode p0 = new SListNode(3);
	//SListNode p5 = new SListNode(15);
	//mylist.insertFront(p0);
	//mylist.insertEnd(p5);
	System.out.println("Here is the same list: "
		       + mylist.toString());
	testEmpty();
